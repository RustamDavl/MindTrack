package ru.rstd.mtrack.core.job.configuration;
...
import ru.rstd.mtrack.core.job.service.properties.QuartzDataSourceProperties;

import javax.sql.DataSource;

@Configuration
@ComponentScan(basePackages = {"ru.rstd.mtrack.core.job.service"})
